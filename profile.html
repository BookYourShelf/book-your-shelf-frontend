...
<head>
    <title>Profile | Book Your Shelf</title>
    <meta charset="utf-8">
                    ...
                    <div class="products_bar d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-start justify-content-center">
                        <div class="breadcrumbs d-flex flex-column align-items-center justify-content-center">
                            <ul class="d-flex flex-row align-items-start justify-content-start text-center">
                                ...
                                <li style="color: #fbaa1d">My Account</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="product_description_area">
            <div class="container">
                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active profile-navbar-text" id="information-tab" data-toggle="tab"
                           href="#information" role="tab" aria-controls="information" aria-selected="true">My
                            Informations</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link profile-navbar-text" id="order-tab" data-toggle="tab" href="#order"
                           role="tab" aria-controls="order" aria-selected="true">My Orders</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link profile-navbar-text" id="address-tab" data-toggle="tab" href="#address"
                           role="tab" aria-controls="address" aria-selected="true">My Addresses</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link profile-navbar-text" id="reviews-tab" data-toggle="tab" href="#reviews"
                           role="tab" aria-controls="reviews" aria-selected="false">My Reviews</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="login">
                                    <div class="container">
                                        <div class="row">
                                            <div class="billing">
                                                <div class="checkout_title">Personal Informations</div>
                                                <div class="login_form_container">
                                                    <form action="#" id="personal_information_form" class="login_form">
                                                        <div>
                                                            <br>
                                                            <!-- Name -->
                                                            <div class="login-text p-b-10" style="color: black;">Name
                                                            </div>
                                                            <input type="email" id="change_name" value="Jane"
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="email" id="change_surname" value="Doe"
                                                                   class="checkout_input form-control"
                                                                   placeholder="Surname">
                                                        </div>
                                                        <div>
                                                            ...
                                                            <input type="email" id="change_email"
                                                                   value="jane_doe@gmail.com"
                                                                   class="checkout_input form-control"
                                                                   placeholder="E-Mail">
                                                        </div>
                                                        <div>
                                                            ...
                                                            <input type="text" id="change_birthdate"
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" id="change_phone"
                                                        ...
                                                        <div><!--ERROR--></div>
                                                        <div class="login_button trans_200"><a
                                                                href="index.html">update</a></div>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="container">
                                    <div class="row">
                                        <div class="billing">
                                            <div class="checkout_title">Password Informations</div>
                                            <div class="login_form_container">
                                                <form action="#" id="login_form" class="login_form">
                                                    <div>
                                                        ...
                                                        <div class="input-group">
                                                            <input type="password" id="current_password"
                                                                   class="checkout_input form-control pwd"
                                                    ...
                                                    <div><!--ERROR--></div>
                                                    <div class="login_button trans_200"><a
                                                            href="thank-you.html">update</a></div>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="products_bar_side d-flex flex-row align-items-end justify-content-end ml-lg-auto">
                                ...
                                <div class="products_dropdown text-right product_dropdown_filter">
                                    <div class="isotope_filter_text"><span>Order Filter</span><i
                                ...
                                <div class="products_dropdown text-right product_dropdown_filter">
                                    <div class="isotope_filter_text"><span>Payment Filter</span><i
                                            class="fa fa-caret-down"
                                            aria-hidden="true"></i></div>
                                    <ul>
                                        <li class="item_filter_btn" data-filter="*">All</li>
                                        <li class="item_filter_btn" data-filter=".sale">Pending</li>
                                        <li class="item_filter_btn" data-filter=".sale">Processed</li>
                                        <li class="item_filter_btn" data-filter=".sale">Completed</li>
                                        <li class="item_filter_btn" data-filter=".sale">Refunded</li>
                                        <li class="item_filter_btn" data-filter=".hot">Failed</li>
                                        <li class="item_filter_btn" data-filter=".sale">Expired</li>
                                        <li class="item_filter_btn" data-filter=".new">Revoked</li>
                                        <li class="item_filter_btn" data-filter=".sale">Preapproved</li>
                                        <li class="item_filter_btn" data-filter=".sale">Cancelled</li>
                                    </ul>
                                </div>
                            </div>
                            <br>
                                                                ...
                                                                <a href="product.html">
                                                                    ...
                                                                    <div class="product_name_container">
                                                                        <div class="cart-product-name"><a
                                                                            ...
                                                                            CiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligiCiftligi</a>
                                                                        </div>
                                                        ...
                                                        <form action="#" id="billing_address_update_form"
                                                            ...
                                                            <div>
                                                                ...
                                                                <select name="billing_address_update_title"
                                                                        ...
                                                                        require="required">
                                                                    <option>Home</option>
                                                                    <option selected>Workplace</option>
                                                                    <option>Summery</option>
                                                                    <option>Other</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="number"
                                                                           id="billing_address_update_zip_code"
                                                                           class="checkout_input form-control"
                                                                           value="06800"
                                                                           required="required">
                                                                </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="text" id="billing_update_open_address_1_id"
                                                                       class="checkout_input form-control"
                                                                       value="Üniversiteler Mahallesi, Hacettepe Beytepe Kampüsü No:21, 06800"
                                                                       placeholder="Full Address" required="required">
                                                            </div>
                                                            ...
                                                            <!-- Button -->
                                                            <div class="login_button trans_200"><a href="#">Update</a>
                                                            </div>
                                                        ...
                                                        <form action="#" id="billing_address_update_form_2"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="text"
                                                                           id="billing_address_update_name_id"
                                                                           class="checkout_input form-control"
                                                                           placeholder="Name" required="required">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="text"
                                                                           id="billing_address_update_surname_id"
                                                                           class="checkout_input form-control"
                                                                           placeholder="Surname"
                                                                           required="required">
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="number"
                                                                           id="billing_address_update_zip_code_id"
                                                                           class="checkout_input form-control"
                                                                           required="required">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           class="checkout_input form-control"
                                                                           value="Üniversiteliler Mahallesi"
                                                                           required="required">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <!-- Zipcode -->
                                                                    ...
                                                                    <input type="number"
                                                                           id="delivery_address_update_zip_code"
                                                                           class="checkout_input form-control"
                                                                           value="06800"
                                                                           required="required">
                                                                </div>
                    ...
                    <div class="tab-pane fade " id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                        ...
                        <!-- No review -->
                        <div class="warning-text" style="display: none">There are no review.</div>
